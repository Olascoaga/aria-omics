...
_SYSTEM = (
    ...
    "the data; (4) the mechanism MUST be hedged speculation — use may/might/could/"
    "suggests/we hypothesize, and do NOT use assertive or causal verbs "
    "(leads to, drives, causes, results in, proves, demonstrates, shows); "
    "(5) every hypothesis needs a concrete discriminating experiment, and its "
    "predicted_direction MUST be a single measurable direction word (increase or "
    "decrease / up or down), never vague ('changes', 'is altered', 'TBD'); "
    "name entities using the EXACT symbols shown in the evidence; "
