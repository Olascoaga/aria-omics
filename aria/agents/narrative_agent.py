...
"""
    ...
    def _summarize_bulk_rna(self, bulk_result: dict,
        ...
        # F3 governance: legacy BulkRNAAgent runs used to attach free-text LLM
        # interpretation here after only regex soft-guarding. Results prose must
        # come from structured DE/pathway outputs and NarrativeBlock evidence
        # cards, so any legacy `interpretation` field is intentionally omitted.
