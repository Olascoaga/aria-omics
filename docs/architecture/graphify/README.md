...
- Commit: `60fe3a0e` (regenerate to refresh)
...
- Structure-only graph: **4880 code nodes / 10157 EXTRACTED structural edges** in
...
- Clustered report: 4880 nodes / 10157 edges / 300 communities in
  `GRAPH_REPORT.md` (291 shown, 9 thin omitted; community detection ignores a
