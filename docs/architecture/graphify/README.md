...
- Commit: `b920d79` (HEAD the graph was built from)
...
- Structure-only graph: **6628 code nodes / 15701 EXTRACTED structural edges** in
...
- Clustered report: 6620 nodes / 14225 edges / 371 communities in
  `GRAPH_REPORT.md` (359 shown, 12 thin omitted; community detection ignores a
