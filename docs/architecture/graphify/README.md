...
- Commit: `e943a1b5` (regenerate to refresh)
...
- Structure-only graph: **4315 code nodes / 10165 EXTRACTED structural edges** in
  `graph.json` (filter dropped 1295 non-code nodes + 1329
  inferred edges, then removed non-structural edges)
- Clustered report: 4308 nodes / 9215 edges / 256 communities in
