...
- Commit: `b921416` (HEAD the graph was built from)
...
- Structure-only graph: **6475 code nodes / 15250 EXTRACTED structural edges** in
...
- Clustered report: 6467 nodes / 13807 edges / 378 communities in
  `GRAPH_REPORT.md` (364 shown, 14 thin omitted; community detection ignores a
