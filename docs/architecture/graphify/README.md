...
- Commit: `429cbb7` (HEAD the graph was built from)
...
- Structure-only graph: **7210 code nodes / 17176 EXTRACTED structural edges** in
...
- Clustered report: 7200 nodes / 15501 edges / 426 communities in
  `GRAPH_REPORT.md` (412 shown, 14 thin omitted; community detection ignores a
