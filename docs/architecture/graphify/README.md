...
- Commit: `911b03d` (HEAD the graph was built from)
...
- Structure-only graph: **6469 code nodes / 15231 EXTRACTED structural edges** in
...
- Clustered report: 6461 nodes / 13787 edges / 395 communities in
