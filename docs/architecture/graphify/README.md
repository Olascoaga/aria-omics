...
- Commit: `daeef91` (HEAD the graph was built from)
...
- Structure-only graph: **8707 code nodes / 19076 EXTRACTED structural edges** in
...
- Clustered report: 8697 nodes / 17268 edges / 576 communities in
  `GRAPH_REPORT.md` (553 shown, 23 thin omitted; community detection ignores a
