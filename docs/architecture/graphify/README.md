...
- Commit: `a2f5415` (HEAD the graph was built from)
...
- Structure-only graph: **7007 code nodes / 16823 EXTRACTED structural edges** in
...
- Clustered report: 6998 nodes / 15205 edges / 410 communities in
  `GRAPH_REPORT.md` (399 shown, 11 thin omitted; community detection ignores a
