...
- Commit: `7a74ba20` (regenerate to refresh)
...
- Structure-only graph: **2444 code nodes / 6534 EXTRACTED structural edges** in
  `graph.json` (filter dropped 760 non-code nodes + 1058
  inferred edges, then removed non-structural edges)
- Clustered report: 2439 nodes / 5891 edges / 114 communities in
