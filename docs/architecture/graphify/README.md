...
- Commit: `572f820` (HEAD the graph was built from)
...
- Structure-only graph: **6928 code nodes / 16494 EXTRACTED structural edges** in
...
- Clustered report: 6919 nodes / 14889 edges / 416 communities in
