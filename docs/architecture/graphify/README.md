...
- Commit: `b7be230d` (regenerate to refresh)
...
- Structure-only graph: **4212 code nodes / 9837 EXTRACTED structural edges** in
  `graph.json` (filter dropped 989 non-code nodes + 1259
  inferred edges, then removed non-structural edges)
- Clustered report: 4206 nodes / 8917 edges / 241 communities in
