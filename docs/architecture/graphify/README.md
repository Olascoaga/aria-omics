...
- Commit: `54e9c6eb` (regenerate to refresh)
...
- Structure-only graph: **2193 code nodes / 5745 EXTRACTED structural edges** in
  `graph.json` (filter dropped 680 non-code nodes + 1004
  inferred edges, then removed non-structural edges)
- Clustered report: ~2189 nodes / ~5161 edges / ~110 communities in
