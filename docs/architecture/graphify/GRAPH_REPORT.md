...
## Summary
- 2190 nodes · 5160 edges · 97 communities (86 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `37ea1d52`
...
Cohesion: 0.06
Nodes (65): Any, bool, float, int, str, _check_env_file_permissions(), _check_llm(), _check_secrets() (+57 more)
...
Cohesion: 0.03
Nodes (16): bool, Path, str, test_hash_file_stable_under_chunk_size(), test_hash_params_order_invariant(), test_orchestrator_does_not_dispatch_on_internal_cp3_resolution(), test_raw_ingestion_agent_updates_scrna_modalities(), test_raw_ingestion_converts_10x_triplet_with_reader_provenance() (+8 more)
...
Cohesion: 0.08
Nodes (35): bool, EvidenceItem, NarrativeBlock, Path, str, bool, EvidenceItem, NarrativeBlock (+27 more)
...
Cohesion: 0.06
Nodes (17): NarrativeAgent, ARIAMemory, LLMProvider, str, bool, NarrativeBlock, Path, str (+9 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (29): DataAuditAgent, DataAuditScanLimits, _env_bool(), _env_float(), _env_int(), _env_optional_int(), _usable_design_col(), _usable_groupby_col() (+21 more)
...
Cohesion: 0.13
Nodes (19): EvidenceItem, NarrativeBlock, find_causal_language(), _causal_block(), _ora_block_with_regulatory_term_name(), test_causal_claim_still_caught_despite_term_name_evidence(), test_find_causal_language_detects_broadened_terms(), test_find_causal_language_exclude_redacts_named_entities() (+11 more)
...
Cohesion: 0.20
Nodes (10): ABC, BaseAgent, DesignStep, CavemanMode, Confidence, MessageType, Enum, LLMProvider (+2 more)
...
Cohesion: 0.13
Nodes (14): ARIAMemory, AuditAgent, BulkRNAAgent, Claim Compiler, DataAuditAgent, DesignAgent, DesignIntelligence, Devil's Advocate (+6 more)
...
- **Why does `BaseAgent` connect `Community 27` to `Community 0`, `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 44`, `Community 12`, `Community 15`, `Community 16`, `Community 19`, `Community 31`?**
  _High betweenness centrality (0.226) - this node is a cross-community bridge._
- **Why does `NarrativeAgent` connect `Community 10` to `Community 2`, `Community 47`, `Community 23`, `Community 25`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `scRNAAgent` connect `Community 5` to `Community 1`, `Community 2`, `Community 27`, `Community 33`?**
