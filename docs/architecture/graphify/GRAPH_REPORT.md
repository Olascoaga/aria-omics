...
## Summary
- 3832 nodes · 7995 edges · 247 communities (231 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `adac8d41`
...
Cohesion: 0.07
Nodes (49): bool, EvidenceItem, NarrativeBlock, Path, str, bool, EvidenceItem, NarrativeBlock (+41 more)
...
Cohesion: 0.07
Nodes (45): _collapse_mex_directories(), DataAuditAgent, DataAuditScanLimits, _env_bool(), _env_float(), _env_int(), _env_optional_int(), _usable_design_col() (+37 more)
...
Cohesion: 0.09
Nodes (53): apply_metadata_corrections(), default_genome_for_organism(), int, Path, str, ask_biological_question(), _collect_metadata_corrections(), _discard_queued_stdin_lines() (+45 more)
...
Cohesion: 0.15
Nodes (20): EvidenceVerificationError, verify_block_claim_support(), EvidenceItem, NarrativeBlock, _block(), test_group_label_integer_is_not_required_on_card(), test_inequality_threshold_value_is_not_required_on_card(), test_supported_correlation_below_two_passes() (+12 more)

### Community 25 - "Community 25"
Cohesion: 0.10
Nodes (18): bool, float, _json_serializer(), _cache_matches(), _cache_params(), _mad_bounds(), rna_qc(), _run_ambient_decontamination() (+10 more)
...
Cohesion: 0.15
Nodes (19): _infer_lfc_threshold(), float, _infer_groups(), _sample_qc(), make_counts(), _patch_light_bulk_de(), _run_bulk(), test_bulk_de_e2e_pipeline() (+11 more)
...
Cohesion: 0.15
Nodes (20): bool, float, int, _site_de_lfc(), _build_design_formula(), _mock_de_result(), _resolve_covariates(), _run_deseq2() (+12 more)
...
Cohesion: 0.36
Nodes (17): Any, float, int, Path, str, _auc(), _finite_float(), _group_means_cpm() (+9 more)
...
Cohesion: 0.19
Nodes (14): load_seqc_maqc_bundle(), run_seqc_maqc_a1_benchmark(), main(), int, str, Path, test_a1_seqc_maqc_real_bundle(), test_auc_separates_classes_and_handles_ties() (+6 more)
...
Cohesion: 0.27
Nodes (14): str, _auto_contrasts(), bulk_rna_de(), _compute_tpm(), _contrast_overlap(), _format_top_genes(), _load_or_infer_metadata(), _prune_outliers_for_design() (+6 more)
...
Cohesion: 0.24
Nodes (13): unwrap_chromatin_findings(), _agent(), _nested_chromatin_agent_result(), test_chromatin_narrator_emits_blocks_from_nested_agent_result(), test_chromatin_qc_finding_handles_uncomputed_frip_tss(), test_design_skips_de_phase_for_chromatin_only_run(), test_design_skips_de_phase_for_other_chromatin_modalities(), test_design_still_fails_when_no_modalities_at_all() (+5 more)
...
Cohesion: 0.26
Nodes (12): int, _resolve_celltypist_model(), rna_celltypist(), _summarize_annotation_confidence(), test_confident_homogeneous_cluster_stays_high(), test_explicit_model_is_not_flagged(), test_frequency_reflects_raw_label_agreement_not_collapsed_majority(), test_missing_probabilities_degrade_to_none_confidence() (+4 more)
...
## Knowledge Gaps
- **915 isolated node(s):** `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode`, `Confidence` (+910 more)
...
- **Why does `BaseAgent` connect `Community 39` to `Community 0`, `Community 34`, `Community 3`, `Community 4`, `Community 36`, `Community 38`, `Community 2`, `Community 8`, `Community 72`, `Community 134`, `Community 78`, `Community 14`, `Community 21`, `Community 23`, `Community 29`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 54` to `Community 33`, `Community 194`, `Community 2`, `Community 58`, `Community 69`, `Community 68`, `Community 73`, `Community 15`, `Community 48`, `Community 21`, `Community 90`, `Community 188`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `Confidence` connect `Community 38` to `Community 2`, `Community 3`, `Community 4`, `Community 39`, `Community 8`, `Community 71`, `Community 78`, `Community 26`, `Community 60`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.030175438596491227 - nodes in this community are weakly interconnected._