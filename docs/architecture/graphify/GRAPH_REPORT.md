# Graph Report - /home/medusa/Samael/ARIA  (2026-06-11)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 3746 nodes · 7796 edges · 222 communities (206 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `acafe468`
...
Cohesion: 0.05
Nodes (90): Any, float, int, str, Any, bool, float, int (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (39): scRNAAgent, ARIAMemory, bool, LLMProvider, Path, str, Any, bool (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (48): bool, NarrativeBlock, Path, str, bool, EvidenceItem, NarrativeBlock, Path (+40 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (44): NarrativeAgent, ARIAMemory, LLMProvider, str, float, Path, str, adapt() (+36 more)
...
Cohesion: 0.03
Nodes (9): bool, _cache_params(), _cache_matches(), test_clustering_cache_requires_matching_parameters(), test_clustering_skip_leiden_when_cluster_col_provided(), test_concat_cache_requires_matching_manifest(), test_integration_cache_requires_matching_parameters(), test_llm_provider_loads_aria_env_file() (+1 more)
...
Cohesion: 0.15
Nodes (31): Any, Path, str, Any, bool, int, Path, str (+23 more)
...
Cohesion: 0.09
Nodes (10): str, hic_inspect(), _inspect_cool(), _inspect_file(), _inspect_hic(), _inspect_mcool(), MockAdvisor, MockEnvManager (+2 more)
...
Cohesion: 0.12
Nodes (20): bool, bool, Any, bool, Path, str, rna_apply_cluster_labels(), rna_celltypist() (+12 more)
...
Cohesion: 0.17
Nodes (25): build_run_ledger(), _bulk_findings_normalized(), link_claims_to_ledger(), _scrna_findings(), _pb_block(), _ran_results(), _skipped_de_results(), test_active_verification_non_strict_collects_without_raising() (+17 more)
...
Cohesion: 0.23
Nodes (7): Path, str, int, _executive_summary_numbers(), _normalize_exec_summary_number(), ReportBuilderMixin, collect_llm_usage()
...
Cohesion: 0.16
Nodes (4): _agent(), _ReportHarness, test_executive_summary_causal_or_unsupported_numbers_fall_back(), test_existing_fallback_executive_summary_is_not_reflagged()
...
Cohesion: 0.17
Nodes (11): Exception, bool, Path, str, LLMProvider, diagnose_llm_failure(), test_diagnose_points_to_the_api_key_the_user_actually_has(), test_diagnose_when_no_key_is_present() (+3 more)
...
Cohesion: 0.35
Nodes (12): Any, bool, str, _entries_for(), _is_planned(), _ledger_modality_group(), LedgerLinkageError, node_id_for() (+4 more)
...
Cohesion: 0.23
Nodes (9): Path, str, float, run_script(), _write_error(), _graph_modularity(), rna_advise_resolution(), _cache_params() (+1 more)
...
## Knowledge Gaps
- **920 isolated node(s):** `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode`, `Confidence` (+915 more)
...
- **Why does `BaseAgent` connect `Community 55` to `Community 1`, `Community 3`, `Community 4`, `Community 37`, `Community 38`, `Community 7`, `Community 72`, `Community 8`, `Community 70`, `Community 11`, `Community 6`, `Community 17`, `Community 20`, `Community 116`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 5` to `Community 0`, `Community 65`, `Community 35`, `Community 6`, `Community 48`, `Community 86`, `Community 24`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 27` to `Community 0`, `Community 34`, `Community 6`, `Community 73`, `Community 16`, `Community 178`, `Community 183`, `Community 29`?**
