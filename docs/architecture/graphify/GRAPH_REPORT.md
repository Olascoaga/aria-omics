...
## Summary
- 4227 nodes · 8969 edges · 248 communities (236 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eed21d9d`
...
Cohesion: 0.06
Nodes (71): Any, str, Any, float, int, Path, str, collect_image_metadata() (+63 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (12): bool, _cache_params(), _cache_matches(), test_clustering_cache_requires_matching_parameters(), test_clustering_skip_leiden_when_cluster_col_provided(), test_concat_cache_requires_matching_manifest(), test_hash_file_stable_under_chunk_size(), test_hash_params_order_invariant() (+4 more)
...
Cohesion: 0.16
Nodes (36): ask_biological_question(), _collect_metadata_corrections(), _data_summary_lines(), _discard_queued_stdin_lines(), _drain_checkpoints(), _launch_context(), _live_analysis_loop(), main() (+28 more)

### Community 23 - "Community 23"
Cohesion: 0.14
Nodes (35): bool, float, int, Message, Path, str, PathLike, _all_input_files() (+27 more)
...
Cohesion: 0.19
Nodes (11): ABC, BaseAgent, DesignStep, CavemanMode, Confidence, MessageType, datetime, Enum (+3 more)
...
Cohesion: 0.13
Nodes (13): App, bool, ComposeResult, str, Paste, Pressed, test_intake_requires_question(), test_intake_routes_multiline_paste_to_question() (+5 more)
...
Cohesion: 0.15
Nodes (14): ComposeResult, int, CheckpointView, ExperimentSnapshot, ExperimentSnapshot, _snap(), test_artifacts_toggle_shows_and_hides(), test_checkpoint_choice_routes_to_resolver() (+6 more)
...
Cohesion: 0.22
Nodes (21): FindingView, LedgerNodeView, ModalityCardView, ProgressEvent, _capture(), ExperimentSnapshot, str, _snap() (+13 more)

### Community 59 - "Community 59"
Cohesion: 0.26
Nodes (21): Any, build_snapshot(), _ledger_views(), _readiness_views(), _eid(), _escalation(), _finding(), str (+13 more)
...
Cohesion: 0.26
Nodes (15): bool, ExperimentSnapshot, float, int, str, Panel, _fmt_duration(), render_artifacts() (+7 more)
...
Cohesion: 0.23
Nodes (10): Path, str, run_script(), _write_error(), make_cluster_figures(), _marker_heatmap(), _qc_depth_violin(), _build_sample_to_group() (+2 more)
...
Cohesion: 0.23
Nodes (11): Any, bool, ExperimentSnapshot, float, str, CheckpointResolver, MetaProvider, SnapshotProvider (+3 more)
...
## Knowledge Gaps
- **947 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+942 more)
...
- **Why does `BaseAgent` connect `Community 41` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 42`, `Community 11`, `Community 45`, `Community 78`, `Community 142`, `Community 18`, `Community 86`, `Community 88`, `Community 28`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 2` to `Community 3`, `Community 39`, `Community 40`, `Community 28`, `Community 81`, `Community 17`, `Community 55`, `Community 60`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `scRNAAgent` connect `Community 4` to `Community 3`, `Community 41`, `Community 9`, `Community 20`, `Community 217`, `Community 126`?**
