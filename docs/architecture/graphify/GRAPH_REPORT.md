...
## Summary
- 2328 nodes · 5567 edges · 109 communities (97 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f4564cc3`
...
Cohesion: 0.07
Nodes (62): Any, bool, NarrativeBlock, str, Path, str, Any, bool (+54 more)
...
Cohesion: 0.05
Nodes (43): Any, bool, int, Path, str, Any, bool, Path (+35 more)
...
Cohesion: 0.07
Nodes (20): NarrativeAgent, ARIAMemory, LLMProvider, str, bool, NarrativeBlock, str, ChromatinNarrator (+12 more)
...
Cohesion: 0.10
Nodes (46): Any, bool, float, NarrativeBlock, str, Any, bool, NarrativeBlock (+38 more)
...
Cohesion: 0.14
Nodes (32): RawIngestionAgent, ARIAMemory, str, Any, Path, str, Any, bool (+24 more)
...
Cohesion: 0.15
Nodes (29): Exception, ask_biological_question(), _collect_metadata_corrections(), _discard_queued_stdin_lines(), _drain_checkpoints(), _live_analysis_loop(), main(), print_agent_message() (+21 more)
...
Cohesion: 0.22
Nodes (11): bool, EvidenceItem, NarrativeBlock, Path, str, BulkRnaNarrator, _evidence(), _parse_gsea_row() (+3 more)
...
Cohesion: 0.19
Nodes (9): Caveat, EvidenceItem, NarrativeBlock, test_render_blocks_fails_on_unsupported_claim_sentence(), test_render_blocks_shows_claim_evidence_caveats_and_validates_files(), test_render_blocks_stores_claim_verification_metadata(), test_block_round_trips_to_dict_for_methodology_json(), test_success_block_requires_claim_and_evidence() (+1 more)
...
Cohesion: 0.20
Nodes (12): NarrativeBlock, ModalityNarrator, NarrativeRegistry, registry_with(), validate_blocks(), test_registry_collects_first_accepting_narrator(), _bulk_findings(), test_bulk_narrator_generates_qc_contrast_pathway_and_power_blocks() (+4 more)
...
Cohesion: 0.14
Nodes (13): aria-rna-env, AuditAgent, BulkRNAAgent, DataAuditAgent, DesignAgent, DesignIntelligence, Devil's Advocate, EnvironmentManager (+5 more)
...
Cohesion: 0.33
Nodes (5): Any, str, build_robustness_multiverse(), test_robustness_multiverse_does_not_invent_intersection_from_counts(), test_robustness_multiverse_manifest_from_pseudobulk_results()
...
## Knowledge Gaps
- **159 isolated node(s):** `APPLY_fixes.sh script`, `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode` (+154 more)
...
- **Why does `BaseAgent` connect `Community 31` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 37`, `Community 70`, `Community 10`, `Community 15`, `Community 48`, `Community 16`, `Community 18`, `Community 17`, `Community 59`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `NarrativeAgent` connect `Community 7` to `Community 0`, `Community 2`, `Community 39`, `Community 48`, `Community 26`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `DataAuditAgent` connect `Community 1` to `Community 2`, `Community 47`, `Community 48`, `Community 20`, `Community 21`, `Community 31`?**
