...
## Summary
- 3857 nodes · 8057 edges · 234 communities (222 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d333d9f4`
...
1. `NarrativeBlock` - 55 edges
2. `EvidenceItem` - 51 edges
3. `scRNAAgent` - 51 edges
4. `read_h5ad()` - 43 edges
5. `OrchestratorAgent` - 42 edges
6. `BaseAgent` - 40 edges
7. `Caveat` - 39 edges
8. `LLMProvider` - 38 edges
9. `BulkRNAAgent` - 37 edges
10. `NarrativeAgent` - 37 edges
...
Cohesion: 0.06
Nodes (40): float, int, str, bool, float, str, bool, str (+32 more)
...
Cohesion: 0.11
Nodes (31): bool, EvidenceItem, NarrativeBlock, Path, str, _annotation_confidence_by_label(), _blocking_integration_caveat(), _design_issues() (+23 more)
...
Cohesion: 0.07
Nodes (15): IntegrationAgent, ARIAMemory, bool, int, LLMProvider, str, str, integration_wnn() (+7 more)
...
Cohesion: 0.14
Nodes (21): EvidenceVerificationError, verify_block_claim_support(), Caveat, EvidenceItem, NarrativeBlock, _block(), test_group_label_integer_is_not_required_on_card(), test_inequality_threshold_value_is_not_required_on_card() (+13 more)
...
Cohesion: 0.18
Nodes (20): bool, object, str, bool, int, Path, str, mocks_allowed() (+12 more)

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (7): _agent(), _PromptCaptureLLM, _ReportHarness, test_executive_summary_causal_or_unsupported_numbers_fall_back(), test_executive_summary_is_first_class_claim_manifest(), test_executive_summary_prompt_delimits_user_text_as_untrusted(), test_existing_fallback_executive_summary_is_not_reflagged()
...
Cohesion: 0.16
Nodes (17): str, rna_pseudobulk_de(), _make_h5ad(), _run(), test_post_hoc_switch_is_rejected(), test_preregister_normalizes_and_declares(), test_primary_column_depends_only_on_strategy(), test_pseudobulk_records_preregistered_fdr_family() (+9 more)
...
Cohesion: 0.25
Nodes (16): Any, bool, NarrativeBlock, str, build_evidence_card(), _claim_entities(), _claim_numbers(), EvidenceCard (+8 more)
...
Cohesion: 0.25
Nodes (14): _bare_agent(), _collect(), _FakeEnv, _findings(), Path_basename(), test_agent_h5mu_flow_dispatches_and_stores_findings(), test_blocks_group_into_chromatin_section(), test_blocks_pass_strict_wclaim_render() (+6 more)
...
Cohesion: 0.28
Nodes (14): Any, bool, str, _bulk_findings_normalized(), _entries_for(), _is_planned(), _ledger_modality_group(), LedgerLinkageError (+6 more)
...
Cohesion: 0.29
Nodes (9): _build_clr_design(), _clr_transform_counts(), rna_diff_abundance(), test_clr_design_adds_donor_fixed_effect_for_paired_design(), test_clr_transform_rows_sum_to_zero(), test_diff_abundance_uses_paired_clr_model(), test_fisher_fallback_is_excluded_from_donor_level_bh(), test_diff_abundance_detects_2x_shift() (+1 more)
...
Cohesion: 0.50
Nodes (4): AuditAgent, DataAuditAgent, DesignAgent, OrchestratorAgent
...
## Knowledge Gaps
- **914 isolated node(s):** `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode`, `Confidence` (+909 more)
...
- **Why does `BaseAgent` connect `Community 36` to `Community 0`, `Community 1`, `Community 34`, `Community 2`, `Community 68`, `Community 5`, `Community 35`, `Community 3`, `Community 72`, `Community 131`, `Community 10`, `Community 43`, `Community 14`, `Community 79`, `Community 17`, `Community 18`, `Community 56`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 4` to `Community 32`, `Community 33`, `Community 3`, `Community 69`, `Community 135`, `Community 50`, `Community 21`, `Community 88`, `Community 186`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 61` to `Community 3`, `Community 165`, `Community 73`, `Community 201`, `Community 80`, `Community 16`, `Community 21`, `Community 86`, `Community 22`, `Community 187`, `Community 188`, `Community 93`?**
