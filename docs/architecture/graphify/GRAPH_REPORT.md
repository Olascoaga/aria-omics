...
## Summary
- 1993 nodes · 4676 edges · 99 communities (90 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `69ba0ffb`
...
- `test_bulk_de_global_contrast_family_is_recorded()` --calls--> `bulk_rna_de()`  [EXTRACTED]
  tests/test_contrast_family_fdr.py → aria/scripts/rna_bulk_de.py
...
Cohesion: 0.09
Nodes (38): bool, float, int, Path, str, float, main(), int (+30 more)
...
Cohesion: 0.08
Nodes (16): Any, bool, int, Path, str, ContractIssue, _manager(), test_environment_manager_attaches_contract_metadata_on_success() (+8 more)
...
Cohesion: 0.18
Nodes (24): bool, NarrativeBlock, Path, str, _apply_causal_guard(), _apply_low_confidence_warning(), _apply_trajectory_guard(), _evidence_is_named_entity() (+16 more)
...
Cohesion: 0.14
Nodes (18): _infer_lfc_threshold(), float, _infer_groups(), _load_or_infer_metadata(), _run_vst(), _sample_qc(), make_counts(), _run_bulk() (+10 more)
...
Cohesion: 0.17
Nodes (14): bool, Any, bool, Path, str, rna_celltypist(), _cache_matches(), rna_clustering() (+6 more)
...
Cohesion: 0.12
Nodes (12): AuditAgent, BulkRNAAgent, Claim Compiler, DataAuditAgent, DesignAgent, DesignIntelligence, EnvironmentManager, MessageBus (+4 more)
...
Cohesion: 0.25
Nodes (6): bulk_rna_de(), _compute_tpm(), _contrast_overlap(), _format_top_genes(), test_golden_bulk_de_recovers_planted_genes(), test_bulk_script_requires_explicit_contrasts()

### Community 70 - "Community 70"
Cohesion: 0.32
Nodes (7): bool, Path, str, LLMProvider, load_aria_env(), _parse_env_line(), record_llm_usage()
...
## Knowledge Gaps
- **147 isolated node(s):** `APPLY_fixes.sh script`, `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode` (+142 more)
...
- **Why does `BaseAgent` connect `Community 28` to `Community 1`, `Community 2`, `Community 35`, `Community 4`, `Community 5`, `Community 3`, `Community 7`, `Community 10`, `Community 12`, `Community 45`, `Community 14`, `Community 46`, `Community 15`, `Community 17`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 20` to `Community 1`, `Community 4`, `Community 7`, `Community 40`, `Community 9`, `Community 78`, `Community 48`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `Confidence` connect `Community 28` to `Community 1`, `Community 67`, `Community 4`, `Community 5`, `Community 39`, `Community 10`, `Community 46`, `Community 17`, `Community 18`, `Community 49`?**
