...
## Summary
- 2441 nodes · 5892 edges · 110 communities (100 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59c91f5f`
...
- `test_find_causal_language_exclude_redacts_named_entities()` --calls--> `find_causal_language()`  [EXTRACTED]
  tests/test_causal_guard.py → aria/agents/narrative/validators.py
- `test_find_causal_language_passes_associative_text()` --calls--> `find_causal_language()`  [EXTRACTED]
  tests/test_causal_guard.py → aria/agents/narrative/validators.py
...
Cohesion: 0.06
Nodes (68): float, str, bool, float, int, str, float, str (+60 more)
...
Cohesion: 0.36
Nodes (7): float, test_bulk_de_global_contrast_family_is_recorded(), test_contrast_family_can_skip_lfc_gate_when_wald_test_used_lfc_null(), test_contrast_family_significance_pools_and_gates_on_lfc(), test_preregister_contrast_family_normalizes_and_declares(), contrast_family_significance(), preregister_contrast_family()
...
## Knowledge Gaps
- **161 isolated node(s):** `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode`, `Confidence` (+156 more)
...
- **Why does `BaseAgent` connect `Community 41` to `Community 2`, `Community 3`, `Community 68`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 52`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 4` to `Community 3`, `Community 9`, `Community 10`, `Community 14`, `Community 18`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `DataAuditAgent` connect `Community 2` to `Community 3`, `Community 41`, `Community 47`, `Community 20`, `Community 22`, `Community 23`?**
