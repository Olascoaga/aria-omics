# Graph Report - /home/medusa/Samael/ARIA  (2026-06-17)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 4601 nodes · 9707 edges · 287 communities (275 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5441968d`
...
7. `run_script()` - 41 edges
8. `BaseAgent` - 40 edges
9. `Caveat` - 40 edges
10. `build_snapshot()` - 39 edges
...
- `test_capability_matrix_keeps_non_scatac_chromatin_scaffold_red()` --calls--> `build_capability_matrix()`  [EXTRACTED]
...
## Communities (287 total, 12 thin omitted)
...
Cohesion: 0.07
Nodes (45): bool, EvidenceItem, NarrativeBlock, Path, str, Caveat, _annotation_confidence_by_label(), _blocking_integration_caveat() (+37 more)
...
Cohesion: 0.09
Nodes (48): Exception, object, str, ask_biological_question(), _collect_metadata_corrections(), _data_summary_lines(), _discard_queued_stdin_lines(), _drain_checkpoints() (+40 more)
...
Cohesion: 0.10
Nodes (15): BulkRNAAgent, _infer_lfc_threshold(), _is_fastq(), _normalise_sample_token(), ARIAMemory, bool, float, LLMProvider (+7 more)
...
Cohesion: 0.08
Nodes (36): Path, str, int, Path, str, _as_float(), chromatin_motifs(), _detect_col() (+28 more)
...
Cohesion: 0.12
Nodes (33): Any, int, str, Any, str, adjusted_rand_index(), ConcordanceResult, _contingency() (+25 more)
...
Cohesion: 0.12
Nodes (21): Any, str, build_robustness_multiverse(), EvidenceItem, NarrativeBlock, test_gsea_prose_nes_matches_evidence_after_rounding_fix(), test_render_blocks_does_not_duplicate_associative_badge_label(), test_render_blocks_fails_on_unsupported_claim_sentence() (+13 more)

### Community 29 - "Community 29"
Cohesion: 0.22
Nodes (30): Any, float, int, Path, str, chromatin_regulatory(), _col(), _corr() (+22 more)
...
Cohesion: 0.14
Nodes (25): Any, float, int, str, ATACDACaller, aria_pseudobulk_da_caller(), run_atac_da_benchmark(), run_atac_pseudobulk_da_benchmark() (+17 more)
...
Cohesion: 0.14
Nodes (26): float, ndarray, float, int, ndarray, str, score_da_lfc_concordance(), _spearman() (+18 more)
...
Cohesion: 0.14
Nodes (20): _infer_groups(), _load_or_infer_metadata(), _run_vst(), _sample_qc(), _select_variable_genes(), make_counts(), _patch_light_bulk_de(), _run_bulk() (+12 more)
...
Cohesion: 0.19
Nodes (17): generate_figures(), render_da_figures(), render_fragment_size_figure(), render_motif_dotplot(), _safe(), _save_dual(), float, int (+9 more)
...
Cohesion: 0.29
Nodes (15): bool, float, str, _basic_chromatin_qc(), _bulk_chromatin_qc(), chromatin_qc(), _compute_fragment_sizes(), _compute_mito_fraction() (+7 more)
...
Cohesion: 0.25
Nodes (14): str, float, str, _generate_plots(), _plot_heatmap(), _plot_pca_mds(), _plot_sample_pca(), _save_single_dr_plot() (+6 more)
...
Cohesion: 0.24
Nodes (10): ScRNAAuditAgent, str, _scrna_context(), test_audit_agent_surfaces_capability_matrix_without_heavy_checks(), test_capability_matrix_keeps_non_scatac_chromatin_scaffold_red(), test_capability_matrix_marks_beta_and_scatac_alpha_as_yellow(), test_scatac_card_is_beta_requires_ack_after_dealpha(), test_scrna_readiness_green_for_publication_ready_pseudobulk() (+2 more)
...
Cohesion: 0.24
Nodes (8): int, _estimate_frip(), _frip_from_intervals(), test_estimate_frip_none_without_peaks(), test_estimate_frip_real_with_peaks_bed(), test_frip_from_intervals_counts_overlaps(), test_frip_from_intervals_empty_is_none(), test_tss_enrichment_unknown_assembly_returns_reason()
...
Cohesion: 0.20
Nodes (6): _audit_agent(), test_chromatin_qc_h5mu_real_is_honest(), test_chromatin_qc_real_hc11_h5mu_validation_input_is_honest(), test_data_audit_detects_and_classifies_h5mu(), test_fragment_sizes_counts_real_barcodes(), test_read_h5mu_summary_file_not_found()
...
Cohesion: 0.24
Nodes (9): Any, Path, str, test_hash_file_stable_under_chunk_size(), test_hash_params_order_invariant(), test_provenance_block_contains_required_fields(), collect_provenance(), hash_file() (+1 more)
...
## Knowledge Gaps
- **1084 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+1079 more)
...
- **Why does `BaseAgent` connect `Community 56` to `Community 129`, `Community 2`, `Community 36`, `Community 4`, `Community 70`, `Community 69`, `Community 8`, `Community 37`, `Community 68`, `Community 166`, `Community 44`, `Community 14`, `Community 48`, `Community 53`, `Community 22`, `Community 25`, `Community 90`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 1` to `Community 32`, `Community 65`, `Community 2`, `Community 38`, `Community 9`, `Community 170`, `Community 45`, `Community 15`, `Community 19`, `Community 85`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 61` to `Community 34`, `Community 2`, `Community 164`, `Community 9`, `Community 237`, `Community 238`, `Community 207`, `Community 13`, `Community 18`, `Community 91`, `Community 252`?**
