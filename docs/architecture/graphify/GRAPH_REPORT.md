# Graph Report - /home/medusa/Samael/ARIA  (2026-06-07)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 2765 nodes · 6424 edges · 146 communities (132 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c650258a`
...
3. `read_h5ad()` - 43 edges
4. `BaseAgent` - 40 edges
5. `OrchestratorAgent` - 39 edges
6. `EvidenceItem` - 38 edges
7. `LLMProvider` - 38 edges
8. `BulkRNAAgent` - 37 edges
9. `run_script()` - 36 edges
10. `ParameterAdvisor` - 34 edges
...
Cohesion: 0.05
Nodes (48): Any, bool, int, Path, str, Any, bool, Path (+40 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (61): Any, bool, NarrativeBlock, str, Path, str, Any, bool (+53 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (62): float, int, Any, bool, float, int, str, ATACDACaller (+54 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (41): Any, ARIAMemory, float, int, LLMProvider, str, Any, bool (+33 more)
...
Cohesion: 0.07
Nodes (38): DataAuditAgent, DataAuditScanLimits, _env_bool(), _env_float(), _env_int(), _env_optional_int(), _usable_design_col(), _usable_groupby_col() (+30 more)
...
Cohesion: 0.13
Nodes (20): Caveat, EvidenceItem, NarrativeBlock, _causal_block(), _ora_block_with_regulatory_term_name(), test_causal_claim_still_caught_despite_term_name_evidence(), test_render_suppresses_warning_when_causal_evidence_declared(), test_render_warns_when_composed_prose_is_causal() (+12 more)
...
Cohesion: 0.19
Nodes (23): BiologicalSynthesisAgent, bool, compose_discussion_blocks(), detect_bulk_patterns(), _contrast(), _scrna_agent_result(), test_agent_returns_empty_without_bulk_results(), test_agent_synthesizes_scRNA_without_bulk() (+15 more)
...
Cohesion: 0.22
Nodes (25): ask_biological_question(), _collect_metadata_corrections(), _discard_queued_stdin_lines(), _drain_checkpoints(), _live_analysis_loop(), main(), print_agent_message(), print_agent_progress() (+17 more)
...
Cohesion: 0.18
Nodes (23): str, float, str, _generate_plots(), _plot_heatmap(), _plot_pca_mds(), _plot_sample_pca(), _save_single_dr_plot() (+15 more)

### Community 33 - "Community 33"
Cohesion: 0.25
Nodes (22): Any, bool, int, Path, str, hash_params(), build_kb_count_command(), _count_gzip_lines() (+14 more)

### Community 34 - "Community 34"
Cohesion: 0.20
Nodes (10): float, int, Path, str, LLMProvider, ModelConfig, test_llm_provider_forces_deterministic_generation(), test_llm_provider_loads_aria_env_file() (+2 more)
...
Cohesion: 0.10
Nodes (17): ARIAMemory, AuditAgent, BiologicalSynthesisAgent, BulkRNAAgent, Claim Compiler, DataAuditAgent, DesignAgent, DesignIntelligence (+9 more)
...
Cohesion: 0.16
Nodes (18): float, str, _abs_corr(), _effective_alpha_from_significant(), _global_bh(), _power_disclosure_for_strategy(), rna_pseudobulk_de(), _shrink_coeff() (+10 more)
...
Cohesion: 0.27
Nodes (12): _binary_pct(), chromatin_diffacc(), _per_cluster_accessibility(), _pseudobulk_da(), _clustered_adata(), test_diffacc_file_not_found(), test_per_cluster_accessibility_runs(), test_per_cluster_skips_single_cluster() (+4 more)
...
Cohesion: 0.29
Nodes (7): lfc_concordance, n_genes_scored, n_true_de_scored, pearson_all_tested, pearson_true_de, spearman_all_tested, spearman_true_de
...
Cohesion: 0.33
Nodes (6): axes, ranking_concordance, rank_biased_overlap_p0.9, top_k, top_k_jaccard, top_k_truth_recall
...
## Knowledge Gaps
- **319 isolated node(s):** `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode`, `Confidence` (+314 more)
...
- **Why does `BaseAgent` connect `Community 37` to `Community 33`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 105`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 49`, `Community 51`, `Community 20`, `Community 53`, `Community 85`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `NarrativeAgent` connect `Community 12` to `Community 1`, `Community 4`, `Community 5`, `Community 37`, `Community 53`, `Community 22`, `Community 25`, `Community 26`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 56` to `Community 2`, `Community 4`, `Community 7`, `Community 14`, `Community 82`, `Community 115`, `Community 116`, `Community 124`, `Community 61`?**
