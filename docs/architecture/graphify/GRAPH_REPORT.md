# Graph Report - /home/medusa/Samael/ARIA  (2026-06-03)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 2189 nodes · 5161 edges · 110 communities (97 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `54e9c6eb`
...
3. `NarrativeAgent` - 40 edges
4. `OrchestratorAgent` - 38 edges
5. `LLMProvider` - 38 edges
6. `read_h5ad()` - 37 edges
7. `BulkRNAAgent` - 36 edges
8. `NarrativeBlock` - 35 edges
9. `ParameterAdvisor` - 34 edges
10. `DataAuditAgent` - 32 edges
...
Cohesion: 0.03
Nodes (16): bool, Path, str, test_hash_file_stable_under_chunk_size(), test_hash_params_order_invariant(), test_llm_provider_loads_aria_env_file(), test_raw_ingestion_agent_updates_scrna_modalities(), test_raw_ingestion_converts_10x_triplet_with_reader_provenance() (+8 more)
...
Cohesion: 0.09
Nodes (7): NarrativeAgent, ARIAMemory, LLMProvider, Path, str, MockLLM, MockMemory
...
Cohesion: 0.14
Nodes (34): RawIngestionAgent, ARIAMemory, str, Any, int, Path, str, Any (+26 more)
...
Cohesion: 0.20
Nodes (25): bool, bytes, float, int, object, Path, str, _as_float() (+17 more)
...
Cohesion: 0.21
Nodes (22): _check_env_file_permissions(), _check_llm(), _check_secrets(), _check_synthetic_assets(), console_main(), main(), _probe_latency(), int (+14 more)
...
Cohesion: 0.21
Nodes (17): Any, bool, float, int, str, DEBenchmarkResult, run_bulk_de_benchmark(), run_pseudobulk_de_benchmark() (+9 more)
...
Cohesion: 0.17
Nodes (18): str, _auto_contrasts(), bulk_rna_de(), _compute_tpm(), _contrast_overlap(), _format_top_genes(), _load_or_infer_metadata(), _prune_outliers_for_design() (+10 more)
...
Cohesion: 0.19
Nodes (19): Any, bool, str, build_devils_advocate(), build_run_ledger(), _is_planned(), _plan_phrases(), _scrna_findings() (+11 more)
...
Cohesion: 0.18
Nodes (10): EvidenceItem, NarrativeBlock, test_render_blocks_fails_on_unsupported_claim_sentence(), test_render_blocks_shows_claim_evidence_caveats_and_validates_files(), test_render_blocks_stores_claim_verification_metadata(), test_block_round_trips_to_dict_for_methodology_json(), test_success_block_requires_claim_and_evidence(), test_non_success_must_explain_failure() (+2 more)
...
Cohesion: 0.12
Nodes (12): AuditAgent, BulkRNAAgent, Claim Compiler, DataAuditAgent, DesignAgent, EnvironmentManager, LLMProvider, MessageBus (+4 more)
...
Cohesion: 0.29
Nodes (10): Any, str, RuntimeError, test_privacy_redacts_paths_and_secrets(), air_gapped_runtime_reason(), assert_egress_allowed(), EgressBlocked, enable_air_gapped_runtime() (+2 more)
...
Cohesion: 0.38
Nodes (9): object, str, Exception, _get_gene_coordinates(), _get_peak_coordinates(), integration_peak2gene(), _load_atac_matrix(), MissingGTFError (+1 more)
...
- **Why does `BaseAgent` connect `Community 36` to `Community 32`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 72`, `Community 42`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 24`?**
  _High betweenness centrality (0.241) - this node is a cross-community bridge._
- **Why does `NarrativeAgent` connect `Community 10` to `Community 1`, `Community 36`, `Community 42`, `Community 43`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `scRNAAgent` connect `Community 2` to `Community 64`, `Community 1`, `Community 34`, `Community 36`, `Community 24`?**
