...
## Summary
- 2328 nodes · 5563 edges · 103 communities (92 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `85da7cf2`
...
Cohesion: 0.06
Nodes (64): Any, bool, NarrativeBlock, str, Path, str, Any, bool (+56 more)
...
Cohesion: 0.06
Nodes (63): float, str, bool, float, int, str, float, str (+55 more)
...
Cohesion: 0.13
Nodes (35): RawIngestionAgent, ARIAMemory, str, Any, Path, str, Any, bool (+27 more)
...
Cohesion: 0.17
Nodes (10): Caveat, EvidenceItem, NarrativeBlock, test_render_blocks_fails_on_unsupported_claim_sentence(), test_render_blocks_shows_claim_evidence_caveats_and_validates_files(), test_render_blocks_stores_claim_verification_metadata(), test_block_round_trips_to_dict_for_methodology_json(), test_success_block_requires_claim_and_evidence() (+2 more)
...
Cohesion: 0.12
Nodes (12): AuditAgent, BulkRNAAgent, DataAuditAgent, DesignAgent, DesignIntelligence, EnvironmentManager, NarrativeAgent, Narrative Kernel (+4 more)
...
Cohesion: 0.20
Nodes (11): NarrativeBlock, ModalityNarrator, NarrativeRegistry, registry_with(), validate_blocks(), test_registry_collects_first_accepting_narrator(), _bulk_findings(), test_bulk_narrator_generates_qc_contrast_pathway_and_power_blocks() (+3 more)
...
## Knowledge Gaps
- **156 isolated node(s):** `APPLY_fixes.sh script`, `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode` (+151 more)
...
- **Why does `BaseAgent` connect `Community 29` to `Community 0`, `Community 35`, `Community 4`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 68`, `Community 11`, `Community 16`, `Community 17`, `Community 19`, `Community 30`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `NarrativeAgent` connect `Community 9` to `Community 1`, `Community 33`, `Community 3`, `Community 26`, `Community 27`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `DataAuditAgent` connect `Community 7` to `Community 3`, `Community 46`, `Community 20`, `Community 21`, `Community 29`, `Community 30`?**
