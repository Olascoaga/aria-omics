...
## Summary
- 4331 nodes · 9252 edges · 264 communities (254 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a323e101`
...
Cohesion: 0.03
Nodes (11): bool, _cache_params(), _cache_matches(), test_clustering_cache_requires_matching_parameters(), test_clustering_skip_leiden_when_cluster_col_provided(), test_concat_cache_requires_matching_manifest(), test_hash_file_stable_under_chunk_size(), test_hash_params_order_invariant() (+3 more)
...
Cohesion: 0.10
Nodes (43): bool, NarrativeBlock, str, bool, EvidenceItem, NarrativeBlock, Path, str (+35 more)
...
Cohesion: 0.19
Nodes (30): Path, str, Any, bool, int, Path, str, ProgressCallback (+22 more)
...
Cohesion: 0.15
Nodes (15): EvidenceItem, NarrativeBlock, _parse_gsea_row(), _to_float(), _to_float_checked(), test_gsea_prose_nes_matches_evidence_after_rounding_fix(), test_render_blocks_does_not_duplicate_associative_badge_label(), test_render_blocks_fails_on_unsupported_claim_sentence() (+7 more)
...
Cohesion: 0.25
Nodes (22): build_snapshot(), status_text(), _eid(), _escalation(), _finding(), str, _status(), test_audit_phase_before_dispatch() (+14 more)
...
Cohesion: 0.17
Nodes (15): float, float, bulk_rna_de(), _format_top_genes(), _run_outlier_sensitivity(), test_bulk_de_global_contrast_family_is_recorded(), test_contrast_family_can_skip_lfc_gate_when_wald_test_used_lfc_null(), test_contrast_family_significance_pools_and_gates_on_lfc() (+7 more)
...
Cohesion: 0.11
Nodes (15): ARIAMemory, AuditAgent, BiologicalSynthesisAgent, BulkRNAAgent, ChromatinAgent, DataAuditAgent, DesignAgent, Devil's Advocate (+7 more)
...
Cohesion: 0.22
Nodes (13): int, str, _auto_contrasts(), _compute_tpm(), _contrast_overlap(), _load_or_infer_metadata(), _mock_de_result(), _prune_outliers_for_design() (+5 more)
...
Cohesion: 0.67
Nodes (3): Any, test_provenance_block_contains_required_fields(), collect_provenance()

## Knowledge Gaps
- **944 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+939 more)
...
- **Why does `collect_version_metadata()` connect `Community 3` to `Community 1`, `Community 66`, `Community 101`, `Community 43`, `Community 44`, `Community 219`, `Community 251`, `Community 81`, `Community 26`, `Community 59`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `BaseAgent` connect `Community 35` to `Community 64`, `Community 65`, `Community 34`, `Community 26`, `Community 2`, `Community 1`, `Community 8`, `Community 41`, `Community 10`, `Community 45`, `Community 80`, `Community 17`, `Community 49`, `Community 24`, `Community 153`, `Community 90`, `Community 123`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 20` to `Community 32`, `Community 1`, `Community 66`, `Community 226`, `Community 13`, `Community 48`, `Community 86`, `Community 218`, `Community 91`, `Community 190`?**
