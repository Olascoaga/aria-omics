...
## Summary
- 4206 nodes · 8917 edges · 241 communities (230 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7be230d`
...
Cohesion: 0.17
Nodes (29): int, Path, str, Any, bool, int, Path, str (+21 more)
...
Cohesion: 0.17
Nodes (10): NarrativeBlock, Path, str, Any, _executive_summary_numbers(), _normalize_exec_summary_number(), ReportBuilderMixin, test_provenance_block_contains_required_fields() (+2 more)
...
Cohesion: 0.17
Nodes (13): ABC, BaseAgent, _infer_lfc_threshold(), DesignStep, float, CavemanMode, Confidence, MessageType (+5 more)
...
Cohesion: 0.16
Nodes (19): bool, float, int, _build_design_formula(), _mock_de_result(), _resolve_covariates(), _run_deseq2(), _run_outlier_sensitivity() (+11 more)
...
Cohesion: 0.22
Nodes (20): ExperimentSnapshot, FindingView, LedgerNodeView, ModalityCardView, ProgressEvent, _capture(), ExperimentSnapshot, str (+12 more)

### Community 64 - "Community 64"
Cohesion: 0.17
Nodes (12): ComposeResult, int, CheckpointView, ExperimentSnapshot, _snap(), test_checkpoint_choice_routes_to_resolver(), test_choice_ignored_when_no_pending_checkpoint(), test_cockpit_e_opens_design_editor() (+4 more)
...
Cohesion: 0.18
Nodes (9): App, ComposeResult, str, Pressed, test_intake_requires_question(), test_intake_submits_data_and_question(), AriaIntakeApp, IntakeResult (+1 more)
...
Cohesion: 0.22
Nodes (13): _sample_qc(), make_counts(), _patch_light_bulk_de(), _run_bulk(), test_bulk_de_e2e_pipeline(), test_bulk_de_multicontrast(), test_deseq2_uses_design_factor(), test_insufficient_replicates_is_graceful() (+5 more)

### Community 77 - "Community 77"
Cohesion: 0.19
Nodes (13): float, bulk_rna_de(), test_golden_bulk_de_recovers_planted_genes(), test_bulk_de_global_contrast_family_is_recorded(), test_contrast_family_can_skip_lfc_gate_when_wald_test_used_lfc_null(), test_contrast_family_significance_pools_and_gates_on_lfc(), test_pooled_bh_is_more_conservative_than_per_group(), test_preregister_contrast_family_normalizes_and_declares() (+5 more)
...
Cohesion: 0.19
Nodes (15): str, _auto_contrasts(), _compute_tpm(), _contrast_overlap(), _format_top_genes(), _infer_groups(), _load_or_infer_metadata(), _prune_outliers_for_design() (+7 more)
...
Cohesion: 0.18
Nodes (9): BulkRNAAgent, ChromatinAgent, DataAuditAgent, DesignAgent, EnvironmentManager, OrchestratorAgent, rna_cellcomm.py (LIANA), rna_trajectory.py (PAGA/DPT) (+1 more)
...
## Knowledge Gaps
- **945 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+940 more)
...
- **Why does `BaseAgent` connect `Community 35` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 132`, `Community 7`, `Community 8`, `Community 11`, `Community 79`, `Community 47`, `Community 83`, `Community 22`, `Community 29`, `Community 62`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 6` to `Community 1`, `Community 2`, `Community 99`, `Community 200`, `Community 43`, `Community 45`, `Community 80`, `Community 23`, `Community 31`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `read_h5ad()` connect `Community 17` to `Community 1`, `Community 133`, `Community 70`, `Community 9`, `Community 10`, `Community 140`, `Community 28`, `Community 49`, `Community 149`, `Community 92`, `Community 93`, `Community 30`?**
