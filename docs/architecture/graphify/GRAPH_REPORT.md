...
## Summary
- 4308 nodes · 9215 edges · 256 communities (248 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e943a1b5`
...
8. `Caveat` - 40 edges
9. `run_script()` - 39 edges
10. `ScrnaNarrator` - 38 edges
...
Cohesion: 0.06
Nodes (72): Any, str, Any, float, int, Path, str, collect_image_metadata() (+64 more)
...
Cohesion: 0.10
Nodes (15): OrchestratorAgent, ARIAMemory, bool, float, int, LLMProvider, Message, str (+7 more)
...
Cohesion: 0.13
Nodes (38): Any, bool, str, build_run_ledger(), _bulk_findings_normalized(), _entries_for(), _is_planned(), _ledger_modality_group() (+30 more)
...
Cohesion: 0.17
Nodes (30): FindingView, LedgerNodeView, ModalityCardView, ProgressEvent, _capture(), ExperimentSnapshot, str, _snap() (+22 more)
...
Cohesion: 0.13
Nodes (20): bool, bool, Any, bool, Path, str, rna_apply_cluster_labels(), _cache_matches() (+12 more)
...
Cohesion: 0.22
Nodes (21): Any, str, ExperimentSession, build_snapshot(), _eid(), _escalation(), _finding(), str (+13 more)

### Community 49 - "Community 49"
Cohesion: 0.22
Nodes (24): bool, ExperimentHistoryView, ExperimentSnapshot, float, int, str, Panel, Text (+16 more)
...
Cohesion: 0.17
Nodes (13): Path, str, float, run_script(), _write_error(), make_cluster_figures(), _marker_heatmap(), _qc_depth_violin() (+5 more)
...
Cohesion: 0.20
Nodes (13): Path, _agent(), test_agent_cellcomm_params_satisfy_the_contract(), test_cellcomm_contract_accepts_cell_type_col_alias(), test_cellcomm_contract_still_rejects_when_neither_key_present(), _discover_dispatched_scripts(), Call, str (+5 more)
...
Cohesion: 0.24
Nodes (13): _chromatin_findings(), unwrap_chromatin_findings(), _agent(), _nested_chromatin_agent_result(), test_chromatin_narrator_emits_blocks_from_nested_agent_result(), test_chromatin_qc_finding_handles_uncomputed_frip_tss(), test_design_skips_de_phase_for_chromatin_only_run(), test_design_skips_de_phase_for_other_chromatin_modalities() (+5 more)
...
Cohesion: 0.27
Nodes (9): ScRNAAuditAgent, str, _scrna_context(), test_audit_agent_surfaces_capability_matrix_without_heavy_checks(), test_capability_matrix_keeps_non_scatac_chromatin_scaffold_red(), test_capability_matrix_marks_beta_and_scatac_alpha_as_yellow(), test_scrna_readiness_green_for_publication_ready_pseudobulk(), test_scrna_readiness_red_blocks_under_replicated_pseudobulk() (+1 more)
...
## Knowledge Gaps
- **934 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+929 more)
...
- **Why does `BaseAgent` connect `Community 32` to `Community 65`, `Community 2`, `Community 1`, `Community 6`, `Community 70`, `Community 9`, `Community 10`, `Community 11`, `Community 44`, `Community 12`, `Community 46`, `Community 79`, `Community 140`, `Community 19`, `Community 27`, `Community 92`, `Community 127`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 0` to `Community 1`, `Community 69`, `Community 39`, `Community 41`, `Community 81`, `Community 213`, `Community 150`, `Community 61`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 21` to `Community 1`, `Community 227`, `Community 69`, `Community 45`, `Community 15`, `Community 87`, `Community 215`, `Community 190`, `Community 93`, `Community 30`?**
