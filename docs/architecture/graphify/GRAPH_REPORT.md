...
## Summary
- 1947 nodes · 4587 edges · 88 communities (78 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aed4853a`
...
Cohesion: 0.03
Nodes (17): bool, Path, str, test_hash_file_stable_under_chunk_size(), test_hash_params_order_invariant(), test_llm_provider_loads_aria_env_file(), test_provenance_block_contains_required_fields(), test_raw_ingestion_agent_updates_scrna_modalities() (+9 more)
...
Cohesion: 0.08
Nodes (8): NarrativeAgent, ARIAMemory, float, LLMProvider, Path, str, MockLLM, MockMemory
...
Cohesion: 0.09
Nodes (49): RawIngestionAgent, ARIAMemory, str, Any, int, Path, str, Any (+41 more)
...
Cohesion: 0.09
Nodes (30): Path, str, float, bool, Any, bool, Path, str (+22 more)
...
Cohesion: 0.13
Nodes (28): Any, bool, NarrativeBlock, str, Any, bool, str, _block_composition_ok() (+20 more)
...
Cohesion: 0.18
Nodes (8): EvidenceItem, NarrativeBlock, test_render_blocks_shows_claim_evidence_caveats_and_validates_files(), test_rna_narrative_adapter_persists_input_hashes(), test_block_round_trips_to_dict_for_methodology_json(), test_success_block_requires_claim_and_evidence(), _de_block(), test_claim_compiler_stats_gate_downgrades_weak_de_claim()
...
Cohesion: 0.21
Nodes (10): NarrativeBlock, ModalityNarrator, NarrativeRegistry, registry_with(), validate_blocks(), test_registry_collects_first_accepting_narrator(), _bulk_findings(), test_bulk_narrator_generates_qc_contrast_pathway_and_power_blocks() (+2 more)
...
## Knowledge Gaps
- **142 isolated node(s):** `APPLY_fixes.sh script`, `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode` (+137 more)
...
- **Why does `BaseAgent` connect `Community 27` to `Community 32`, `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 38`, `Community 7`, `Community 8`, `Community 39`, `Community 6`, `Community 11`, `Community 14`, `Community 15`, `Community 18`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `scRNAAgent` connect `Community 4` to `Community 0`, `Community 9`, `Community 44`, `Community 57`, `Community 27`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `NarrativeAgent` connect `Community 3` to `Community 0`, `Community 39`, `Community 41`, `Community 25`, `Community 27`?**
