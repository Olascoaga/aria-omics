...
## Summary
- 4141 nodes · 8729 edges · 245 communities (232 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e46ee298`
...
Cohesion: 0.17
Nodes (30): Any, int, Path, str, Any, bool, int, Path (+22 more)
...
Cohesion: 0.19
Nodes (28): ask_biological_question(), _collect_metadata_corrections(), _discard_queued_stdin_lines(), _drain_checkpoints(), _live_analysis_loop(), main(), print_agent_message(), print_agent_progress() (+20 more)
...
Cohesion: 0.18
Nodes (8): DesignStep, CavemanMode, Confidence, MessageType, datetime, Enum, TaskTier, record_llm_usage()
...
Cohesion: 0.18
Nodes (12): App, int, ComposeResult, CheckpointView, ExperimentSnapshot, ExperimentSnapshot, _snap(), test_checkpoint_choice_routes_to_resolver() (+4 more)
...
Cohesion: 0.37
Nodes (15): build_snapshot(), _eid(), _escalation(), _finding(), str, _status(), test_audit_phase_before_dispatch(), test_design_phase_on_design_checkpoint() (+7 more)
...
Cohesion: 0.32
Nodes (13): FindingView, ProgressEvent, _capture(), ExperimentSnapshot, str, _snap(), test_checkpoint_idle_and_complete(), test_checkpoint_lists_numbered_options() (+5 more)
...
Cohesion: 0.24
Nodes (12): Any, bool, float, Message, str, _confidence_label(), _detect_completion(), _ledger_views() (+4 more)
...
Cohesion: 0.28
Nodes (12): bool, ExperimentSnapshot, float, int, str, Panel, _fmt_duration(), render_checkpoint() (+4 more)
...
Cohesion: 0.18
Nodes (8): BulkRNAAgent, DataAuditAgent, DesignAgent, EnvironmentManager, OrchestratorAgent, rna_cellcomm.py (LIANA), rna_trajectory.py (PAGA/DPT), scRNAAgent
...
## Knowledge Gaps
- **943 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+938 more)
...
- **Why does `BaseAgent` connect `Community 50` to `Community 0`, `Community 1`, `Community 33`, `Community 2`, `Community 6`, `Community 136`, `Community 11`, `Community 12`, `Community 44`, `Community 80`, `Community 49`, `Community 19`, `Community 84`, `Community 20`, `Community 25`, `Community 28`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 4` to `Community 0`, `Community 99`, `Community 39`, `Community 40`, `Community 203`, `Community 76`, `Community 18`, `Community 57`, `Community 25`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `read_h5ad()` connect `Community 14` to `Community 0`, `Community 68`, `Community 101`, `Community 9`, `Community 10`, `Community 48`, `Community 153`, `Community 26`, `Community 29`, `Community 94`, `Community 95`?**
