# Graph Report - /home/medusa/Samael/ARIA  (2026-06-04)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 2333 nodes · 5579 edges · 123 communities (108 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `531428a0`
...
3. `OrchestratorAgent` - 39 edges
4. `NarrativeBlock` - 38 edges
5. `LLMProvider` - 38 edges
6. `BulkRNAAgent` - 37 edges
7. `read_h5ad()` - 37 edges
8. `ParameterAdvisor` - 34 edges
9. `DataAuditAgent` - 33 edges
10. `bulk_rna_de()` - 33 edges
...
Cohesion: 0.06
Nodes (44): bool, EvidenceItem, NarrativeBlock, Path, str, bool, NarrativeBlock, str (+36 more)
...
Cohesion: 0.08
Nodes (16): NarrativeAgent, ARIAMemory, LLMProvider, str, _agent(), _bulk_agent_results(), _exp_ctx(), test_bulk_executive_summary_is_deterministic_and_grounded() (+8 more)
...
Cohesion: 0.12
Nodes (22): render_blocks(), EvidenceItem, NarrativeBlock, find_causal_language(), _causal_block(), _ora_block_with_regulatory_term_name(), test_causal_claim_still_caught_despite_term_name_evidence(), test_find_causal_language_detects_broadened_terms() (+14 more)
...
Cohesion: 0.20
Nodes (5): OrchestratorAgent, bool, Message, str, ExperimentSession
...
Cohesion: 0.20
Nodes (21): NarrativeBlock, bool, NarrativeBlock, Path, str, _apply_causal_guard(), _apply_low_confidence_warning(), _apply_trajectory_guard() (+13 more)
...
Cohesion: 0.18
Nodes (16): _infer_groups(), _sample_qc(), make_counts(), _patch_light_bulk_de(), _run_bulk(), test_bulk_de_e2e_pipeline(), test_bulk_de_multicontrast(), test_deseq2_uses_design_factor() (+8 more)
...
Cohesion: 0.22
Nodes (6): DesignIntelligence, bool, str, test_design_intelligence_downgrades_bulk_at_n2(), test_design_intelligence_downgrades_pseudobulk_at_n2(), test_design_intelligence_scrna_focused_group_feasibility()
...
Cohesion: 0.22
Nodes (9): _infer_lfc_threshold(), float, int, Path, str, FileHandler, test_lfc_threshold_tf_vs_nontf(), attach_experiment_log() (+1 more)
...
Cohesion: 0.20
Nodes (9): BulkRNAAgent, Claim Compiler, DataAuditAgent, DesignAgent, EnvironmentManager, MessageBus, NarrativeAgent, OrchestratorAgent (+1 more)
...
Cohesion: 0.25
Nodes (4): format_design_intelligence(), int, float, int
...
## Knowledge Gaps
- **157 isolated node(s):** `APPLY_fixes.sh script`, `float`, `ARIAMemory`, `LLMProvider`, `CavemanMode` (+152 more)
...
- **Why does `BaseAgent` connect `Community 26` to `Community 2`, `Community 35`, `Community 4`, `Community 5`, `Community 68`, `Community 7`, `Community 39`, `Community 3`, `Community 10`, `Community 12`, `Community 13`, `Community 79`, `Community 48`, `Community 20`, `Community 24`, `Community 30`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 43` to `Community 96`, `Community 97`, `Community 2`, `Community 5`, `Community 6`, `Community 71`, `Community 104`, `Community 14`, `Community 50`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `DataAuditAgent` connect `Community 4` to `Community 2`, `Community 68`, `Community 44`, `Community 16`, `Community 18`, `Community 26`?**
