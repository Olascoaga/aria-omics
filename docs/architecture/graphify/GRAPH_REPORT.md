...
## Summary
- 4412 nodes · 9419 edges · 250 communities (243 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `508b1734`
...
## Communities (250 total, 7 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (19): CompletedProcess, _assert_legacy_script_passed(), bool, Path, str, test_hash_params_order_invariant(), test_legacy_script_wrapper_rejects_printed_failures(), test_llm_provider_loads_aria_env_file() (+11 more)
...
Cohesion: 0.11
Nodes (40): bool, NarrativeBlock, str, bool, EvidenceItem, NarrativeBlock, Path, str (+32 more)
...
Cohesion: 0.04
Nodes (45): aria_version, artifacts, manifest_json, benchmark, benchmark_version, cluster_concordance, da_peak_concordance, containerized (+37 more)
...
Cohesion: 0.17
Nodes (34): bool, float, int, _finite_float(), NegativeControlResult, run_bulk_de_benchmark(), run_bulk_de_negative_control(), run_bulk_de_spike_in() (+26 more)
...
Cohesion: 0.14
Nodes (25): bool, EvidenceVerificationError, verify_block_claim_support(), render_blocks(), EvidenceItem, NarrativeBlock, _block(), test_group_label_integer_is_not_required_on_card() (+17 more)
...
Cohesion: 0.15
Nodes (19): _infer_lfc_threshold(), float, _infer_groups(), make_counts(), _patch_light_bulk_de(), _run_bulk(), test_bulk_de_e2e_pipeline(), test_bulk_de_multicontrast() (+11 more)
...
Cohesion: 0.15
Nodes (19): Any, str, _bh_adjust(), _naive_cell_level_null_calls(), run_bulk_de_a1_benchmark(), run_pseudobulk_a2_benchmark(), _run_pseudobulk_null_calls(), sweep_bulk_de_lfc_threshold() (+11 more)
...
Cohesion: 0.28
Nodes (21): build_snapshot(), _heartbeat_event(), _eid(), _escalation(), _finding(), str, _status(), test_audit_phase_before_dispatch() (+13 more)

### Community 66 - "Community 66"
Cohesion: 0.20
Nodes (20): str, float, int, str, _to_symbols(), _auto_contrasts(), bulk_rna_de(), _compute_tpm() (+12 more)
...
Cohesion: 0.19
Nodes (16): bool, float, int, _build_design_formula(), _mock_de_result(), _resolve_covariates(), _run_deseq2(), _run_outlier_sensitivity() (+8 more)
...
Cohesion: 0.27
Nodes (10): float, str, _generate_plots(), _plot_heatmap(), _plot_pca_mds(), _plot_sample_pca(), _save_single_dr_plot(), _run_vst() (+2 more)
...
Cohesion: 0.32
Nodes (7): Any, Path, str, benchmark_scatac_reference_snapatac2(), _run_reference_pipeline(), test_reference_driver_honest_not_run_when_snapatac2_absent(), test_reference_driver_honest_not_run_without_input()
...
## Knowledge Gaps
- **980 isolated node(s):** `float`, `int`, `float`, `ARIAMemory`, `LLMProvider` (+975 more)
...
- **Why does `BaseAgent` connect `Community 41` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 68`, `Community 6`, `Community 38`, `Community 72`, `Community 70`, `Community 137`, `Community 11`, `Community 13`, `Community 82`, `Community 51`, `Community 20`, `Community 117`, `Community 54`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `collect_version_metadata()` connect `Community 4` to `Community 0`, `Community 1`, `Community 98`, `Community 46`, `Community 49`, `Community 147`, `Community 84`, `Community 21`, `Community 26`, `Community 60`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `rna_pseudobulk_de()` connect `Community 33` to `Community 0`, `Community 1`, `Community 40`, `Community 210`, `Community 211`, `Community 212`, `Community 182`, `Community 22`, `Community 26`, `Community 60`, `Community 222`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.02612330198537095 - nodes in this community are weakly interconnected._
