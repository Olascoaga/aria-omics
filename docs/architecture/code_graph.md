...
| `rna_pseudobulk_de.py` or `rna_diff_abundance.py` | `scrna_agent.py`, `ScrnaNarrator`, power/global-FDR report text | These scripts drive publication-facing inferential claims. |
