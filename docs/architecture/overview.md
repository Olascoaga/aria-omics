...
| ChromatinAgent | Orchestrates beta scATAC behind acknowledgement and the V47 bulk ATAC beta QC/peak-calling slice; ChIP/CUT&RUN/CUT&TAG remain scaffolded |
